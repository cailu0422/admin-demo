(function() {
    ...
    angular.module('BlurAdmin.pages.posts').controller('PostsApprovedController', PostsApprovedController);

    function PostsApprovedController($scope, $http, ADMIN_VALUE, $state, $uibModal) {
        var vm = this;
        $scope.selectedPost = [];
        $scope.postsDataList = [];
