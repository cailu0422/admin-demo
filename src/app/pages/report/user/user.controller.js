(function() {
    ...
    angular.module('BlurAdmin.pages.report').controller('ReportUserController', ReportUserController);

    function ReportUserController($scope, $http, ADMIN_VALUE, $state, $uibModal) {
        var vm = this;
        $scope.selectedPost = [];
        $scope.postsDataList = [];
        $scope.smartTablePageSize = 10;
        getPendingPostList();
console.log('ReportUserController');
